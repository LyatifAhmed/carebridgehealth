...
const routes = [
  ...
  {
    path: "/cosmetic-surgery-turkey",
    changeFrequency: "weekly",
    priority: 0.85,
  },

  {
    path: "/weight-loss-surgery-turkey",
    changeFrequency: "weekly",
    priority: 0.85,
  },
  {
